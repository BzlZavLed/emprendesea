 ...
 namespace App\Controller;
  ...
  use Symfony\Bundle\FrameworkBundle\Controller\Controller;
    ...
    */
    ...
    /**
    * @Route("/fronteras", name="fronteras")
    * @Method("GET")
    */
    public function fronteras(){
      $legal = $this->getDoctrine()->getRepository(Legal::class)->findAll();
      return $this->render('store/temporal.php', array('menu' => 1, 'legal' => $legal));
    }
    /**
    ...
    */
    public function universitarios(){
      ...
      $legal = $this->getDoctrine()->getRepository(Legal::class)->findAll();
      $variable = "perro";
      return $this->render('store/students.html.twig', array('menu' => 2, 'legal' => $legal, 'students' => $students, 'escuela'=>$escuela, 'filted'=>false, 'uni'=>null, 'variable'=> $variable));
    }
    /**
...
*/
      ...
      //$eArray = array();
      /*$eArray ;
      $eArray -> mail = $alumMail;
      $eArray -> photo = $alumPhoto;
      $eArray -> id = $alumId;
      $eArray -> name = $alumName;
      $ejson = json_encode($eArray);*/
      $total = 0;
      $totalList = 0;
      foreach ($content as $item) {
        $book = $entityManager->getRepository(Books::class)->find($item->getBookId());
      ...
      //array_push($eArray, ["mail" => $alumMail, "photo" => $alumPhoto, "id" => $alumId, "name" => $alumName]);
      $post = [
      "line_items"=> $cArray,
     ...
     //"metadata"=> array("reference"=> $pedido->getId(), "more_info"=> $eArray[0]),
