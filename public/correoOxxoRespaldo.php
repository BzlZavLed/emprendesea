  ...
  <div style='width: 100% ;height: auto ;background-color  : #2c6ded;' >
    <table style='border:0' >
      ...
      $asuntoV .= $alumno;
         ...
         enviarMail('contactoemprendum@um.edu.mx', $asuntoV,utf8_decode($content_donante));
         enviarMail('contactoemprendum@um.edu.mx', $asunto,utf8_decode($content_envio));
         enviarMail('contactoemprendum@um.edu.mx', $asuntoV,utf8_decode($content_alumno));
          $success=enviarMail('contactoemprendum@um.edu.mx', $asunto,$content_emprendum);
