...
// guardar aqui en variables lo que traiga 
    ...
    desglose <span style='color: #696969; font-weight: bold;'>ESTIMADO</span> de cómo quedará tu depósito a la
    Universidad: 
  ...
  <table style='border:0' >
    ...
    ";
      ...
      $asuntoV .= $alumno;
        ...
        enviarMail($respaldo, $asunto,$content_emprendum);
        enviarMail('benefactoremprendum@um.edu.mx', $asunto,utf8_decode($content_envio));
        $success=enviarMail('benefactoremprendum@um.edu.mx', $asunto,$content_emprendum);
...
function enviarMail($correoBene,$asunto,$contenido){
  ...
  try {
      ...
      $mail->Username = 'benefactoremprendum@um.edu.mx';                 // SMTP username
      $mail->Password = 'tajecolpor';                        // SMTP password
      ...
      //Recipients
      $mail->setFrom('benefactoremprendum@um.edu.mx', utf8_decode('Emprendum'));
