   ...
   // $correoBene = 'edny_k3@hotmail.com';
        ...
        <div>
          ...
          <div style='margin-top: 26px; position: relative;'>
            <div style='width: 45%; float: left;'><img style='max-width: 150px; margin-top: 2px;' src='https://emprendum.um.edu.mx/images/oxxopay.png' alt='OXXOPay'></div>
        ...
        $success=enviarMail('benefactoremprendum@um.edu.mx', $asunto,$content_donante);
